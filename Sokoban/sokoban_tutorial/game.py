...
class Game:
    ...
    def auto_move(self):
        ...
        runtime_level.append([self.index_level,name_strategy,runtime])
        f = open("output_" + str(name_strategy) +".txt", "a")
        f.write(str(self.index_level)+ ' ' + str(name_strategy)+ ' '+str(runtime)+ ' ' + str(len(strategy)) +"\n")
        f.close()
        #print("RUNTIME LEVEL", runtime_level)
